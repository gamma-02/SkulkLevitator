...
public class Shulklevitator implements ModInitializer {
    ...
    public static Potion LEVITATION_POTION = Registry.register(Registry.POTION, new Identifier(modid, "levitation"), new Potion("levitation", new StatusEffectInstance(StatusEffects.LEVITATION, 3600)));
    public static Potion LONG_LEVITATION_POTION = Registry.register(Registry.POTION, new Identifier(modid, "long_levitation"), new Potion("levitation", new StatusEffectInstance(StatusEffects.LEVITATION, 9600)));
    public static Potion MEDIUM_LEVITATION_POTION = Registry.register(Registry.POTION, new Identifier(modid, "medium_levitation"), new Potion("levitation", new StatusEffectInstance(StatusEffects.LEVITATION, 4800)));
    public static Potion MEDIUM_LONG_LEVITATION_POTION = Registry.register(Registry.POTION, new Identifier(modid, "medium_long_levitation"), new Potion("levitation", new StatusEffectInstance(StatusEffects.LEVITATION, 12000)));
    ...
    public static StatusEffect FLIGHT = Registry.register(Registry.STATUS_EFFECT, new Identifier(modid, "flight_effect"), new FlightStatusEffect());
    ...
    public void onInitialize() {
        ...
        PotionDispenserBehaviors.registerPotionBehavior(DispenserUtils.SHULK_POTION_BEHAVIOR, LEVITATION_POTION, LONG_LEVITATION_POTION, MEDIUM_LEVITATION_POTION, MEDIUM_LONG_LEVITATION_POTION);

        registerPotionRecipe(Potions.SLOW_FALLING, SHULKER_BULLET_BOTTLE, LEVITATION_POTION);
        registerPotionRecipe(Potions.LONG_SLOW_FALLING, SHULKER_BULLET_BOTTLE, MEDIUM_LEVITATION_POTION);
        registerPotionRecipe(LEVITATION_POTION, Items.REDSTONE, LONG_LEVITATION_POTION);
        registerPotionRecipe(MEDIUM_LEVITATION_POTION, Items.REDSTONE, MEDIUM_LONG_LEVITATION_POTION);
    }
