...
public class Shulklevitator implements ModInitializer {
    ...
    public static ItemGroup modGroup = FabricItemGroupBuilder.create(new Identifier(modid, "group")).icon(() -> SHULKER_BULLET_BOTTLE.getDefaultStack()).build();
    public static Block REGULAR_SHULK_LEVITATOR_BLOCK = Registry.register(Registry.BLOCK, new Identifier(modid, "regular_shulk_levitator_block"), new RegularShulkLevitatorBlock(FabricBlockSettings.copy(Blocks.SHULKER_BOX).nonOpaque()));
    public static Block UPGRADED_SHULK_LEVITATOR_BLOCK = Registry.register(Registry.BLOCK, new Identifier(modid, "upgraded_shulk_levitator_block"), new UpgradedShulkLevitatorBlock(FabricBlockSettings.copy(Blocks.SHULKER_BOX).nonOpaque()));
    public static BlockEntityType<ShulkLevitatorBlockEntity> SHULK_LEVITATOR_TYPE = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(modid, "shulk_levitator_block_entity_type"), FabricBlockEntityTypeBuilder.create(ShulkLevitatorBlockEntity::new, REGULAR_SHULK_LEVITATOR_BLOCK, UPGRADED_SHULK_LEVITATOR_BLOCK).build(null));
    public static BlockItem REGULAR_SHULK_BLOCK = Registry.register(Registry.ITEM, new Identifier(modid, "regular_shulk_levitator_item"), new BlockItem(REGULAR_SHULK_LEVITATOR_BLOCK, new FabricItemSettings().group(modGroup)));
    public static BlockItem UPGRADED_SHULK_BLOCK = Registry.register(Registry.ITEM, new Identifier(modid, "upgraded_shulk_levitator_item"), new BlockItem(UPGRADED_SHULK_LEVITATOR_BLOCK, new FabricItemSettings().group(modGroup)));
